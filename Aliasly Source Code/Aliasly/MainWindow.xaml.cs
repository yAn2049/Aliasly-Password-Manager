...
public partial class MainWindow : Window
{
    ...
    private void uj_kulcs_Click(object sender, RoutedEventArgs e) // Új mesterkulcs hozzáadása gomb esemény - Register 
    {
        ...
        try
        {
            ...
            {
                MessageBox.Show("Ez a mesterkulcs már létezik", "Mesterkulcs hiba!", MessageBoxButton.OK, MessageBoxImage.Exclamation);
                return;
            }
            else
            {
                ...
                MessageBox.Show("A mesterkulcs sikeresen hozzá lett adva az adatbázishoz.", "Mesterkulcs hozzáadva!", MessageBoxButton.OK, MessageBoxImage.Information);
...

    {
        ...
        try
        {
            ...
            if (van_mar_ilyen_kulcs)
            {
                ...
                MessageBox.Show($"Sikeres bejelentkezés!\nKulcs id: {AktivKulcsId}\n", "Bejelentkezés sikeres!", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        if (button != null)
        {
            ...
            try
            {
                ...
                if (result == MessageBoxResult.Yes)
                {
                    ...
                    // felhasznalo visszajelzes
                    MessageBox.Show($"A(z) {sor_id}. sor törölve lett az adatbázisból!", "Rekord törölve!", MessageBoxButton.OK, MessageBoxImage.Information);
                }
